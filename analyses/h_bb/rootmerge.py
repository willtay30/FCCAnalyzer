...
#####
# Warning! Currently ignores Tgraphs(jet stuff)
####

path = "/home/submit/aniketkg/FCCAnalyzer/output/hbb_tagging/histmaker/"
...
output_file = "analyses/h_bb/end_of_h_bb.root"
...
for s in dir_list: #for each output file
    ...
    for h in a: # for each item in root file
        ...
        if event.Class_Name() == "TH1D": #if histogram, add to list
